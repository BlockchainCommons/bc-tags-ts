/**
 * The vector shape for this package (Phase 1.2): the full tag table and the
 * registry a fresh `registerTags()` produces. Works over any module shape,
 * pre- or post-redesign, so the golden, differential and generator scripts
